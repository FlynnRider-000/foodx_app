...
class S {
  ...
  String get market_minimum_order {
    return Intl.message(
      'Total amount is less than mini order and you will be charged delivery fee\n \nMinimum Order is %i\nDeliver Fee is %.2f',
      name: 'market_minimum_order',
      desc: '',
      args: [],
    );
  }

  /// `Total amount is less than mini order and can't proceed further until the total amount above minimum amount\n\nMinimum Order is %i`
  String get market_limited_order {
    return Intl.message(
      'Total amount is less than mini order and can\'t proceed further until the total amount above minimum amount\n\nMinimum Order is %i',
      name: 'market_limited_order',
      desc: '',
      args: [],
    );
  }
  ...
  /// `You can add special note/instruction here`
  String get add_note_helper {
    return Intl.message(
      'You can add special note/instruction here',
      name: 'add_note_helper',
      desc: '',
      args: [],
    );
  }
  ...
  /// `App will capture your current location and save it`
  String get capture_location_help {
    return Intl.message(
      'App will capture your current location and save it',
      name: 'capture_location_help',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Google Map Api Key had been expried`
  String get google_map_key_expired {
    return Intl.message(
      'Google Map Api Key had been expried',
      name: 'google_map_key_expired',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_order_has_not_been_submitted {
    return Intl.message(
      'Your order has not been submitted!',
      name: 'your_order_has_not_been_submitted',
      desc: '',
      args: [],
    );
  }
