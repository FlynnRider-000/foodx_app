              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Opacity(
                    opacity: 0.4,
                    child: Text(
                      _con.placeOrderSuccess ? S.of(context).your_order_has_been_successfully_submitted : S.of(context).your_order_has_not_been_submitted,
                      textAlign: TextAlign.center,
                      style: Theme.of(context).textTheme.headline3.merge(TextStyle(fontWeight: FontWeight.w300)),
                    ),
                  ),
                  _con.orderNotPlacedStr != "" ?
                    Opacity(
                      opacity: 0.6,
                      child: Text(
                        _con.orderNotPlacedStr,
