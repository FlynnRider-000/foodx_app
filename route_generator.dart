...
import 'src/pages/razorpay_failed.dart';
...
import 'src/pages/confirm_allow_location.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/ConfirmAllowLocation':
        return MaterialPageRoute(builder: (_) => ConfirmAllowLocationWidget());
      case '/Splash':
      ...
      case '/RazorPayFailed':
        return MaterialPageRoute(builder: (_) => RazorPayFailedWidget(errorInfoStr: args));
      case '/Languages':
